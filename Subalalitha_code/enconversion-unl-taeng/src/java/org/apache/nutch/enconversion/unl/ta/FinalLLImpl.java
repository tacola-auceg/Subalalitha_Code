...
//	PrintStream ugt;
	...
	public void addConcept(String w,String uw,String cid,String did,String sid,String posck,String freqcount, String queryTag,String MWtag_Qw)
	// post: appends the specified element to the end of this list.
	{
		//System.out.println("Add Concept:"+w+" "+uw+" "+cid+" "+did+" "+sid+" "+posck+" "+freqcount+" "+queryTag+" "+MWtag_Qw);
		ConceptNode temp = new ConceptNode(w,uw,cid,did,sid,posck,freqcount,queryTag,MWtag_Qw);
