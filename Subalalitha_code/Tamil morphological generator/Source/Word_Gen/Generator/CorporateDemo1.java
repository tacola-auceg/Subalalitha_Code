...
try{
	 	for(int i=0 ;i<adv_verb_aux_tense.length;i++){
	 		System.out.println("STring array:"+adv_verb_aux_tense[i].toString());
	 	}
}catch(Exception e){}
...
//ps.println("verb"+verb);
 	...
 	System.out.println("the case ending  "+case1);
	 	 ...
	 	 else if(!(case1.equals(case_str[0])))
	 	 {
	 	 	...
	 	 	case1result = " "+caseobj.addCase(noun1,case1,"",issingular1);
	 	 	//System.out.println("case result:"+tm.revert(case1result));
	 	 	System.out.println("case result:"+case1result);
	 	 }
