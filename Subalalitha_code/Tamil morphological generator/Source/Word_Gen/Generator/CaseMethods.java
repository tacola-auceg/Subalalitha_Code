...
//PrintStream ps = new PrintStream(new FileOutputStream(new File("/usr/output/case.txt")));
	System.out.println("noun in caes method"+nounstr.trim());
	System.out.println("case1"+case1str.trim());
	System.out.println("ncase2"+case2str.trim());
...
//ps.println("i am here");
				System.out.println("entered the singular number"+case1.length);
...
//ps.println("no i am here");
                       ...
                       if(flag==1){
							...
							if((bm.isequal(case1,ku))||(bm.isequal(case2,ku))||(bm.isequal(case1,ukku)))
							{	System.out.println("entered casesshfkh");
...
//}			
							...
							result=sm.sandhimeth(nounbyte,case1);}
								System.out.println("result in addcase:"+result);
							...
							/************************************************88888888*/	else if((((nounbyte[nounbyte.length-1])==9)||((nounbyte[nounbyte.length-1])==3)||((nounbyte[nounbyte.length-1])==4)||((nounbyte[nounbyte.length-1])==8)||((nounbyte[nounbyte.length-1])==12)||((nounbyte[nounbyte.length-1])==24))&&((bm.isequal(case1,kkaka))||(bm.isequal(case1,kku))||(bm.isequal(case2,kkaka))||(bm.isequal(case2,kku))))
							
							 {
							//System.out.println("nounbyte   "+(nounbyte[nounbyte.length-1]));
							//System.out.println("case1   "+case1str);
							result=sm.sandhimeth(nounbyte,case1);
							System.out.println(" required result   "+tm.revert(result));
							return tm.revert(result);
							}
							...
							/* for(int i=0;i<exceptions.length;i++)
							  ...
							  //}
                                                  ...
                                                  //modifeid   else if (flag==1)
                                                     //modified	{

							 if((case1str.equals(itamirunthu))||(case1str.equals(ilirunthu))||(case1str.equals(ai))||(case1str.equals(udaiya))||(case1str.equals(aal))||(case1str.equals(itam))||(case1str.equals(il))||(case1str.equals(Odu))||(case1str.equals(udan)||(case1str.equals(udan)&& case2str.endsWith("ம்"))))
							 {
								System.out.println("nounbyte   "+(nounbyte[nounbyte.length-1]));
								...
								result=sm.sandhimeth(nounbyte,case1);
								System.out.println("the result new"+tm.revert(result));//result);
...
//else for other cases that is case2string ==ai and case2string
					...
					{//else starts
						...
						System.out.println("entered the else plural number"+case1str);
						//if(case2.length==1 && case2[case2.length-1]==0 )//||case1.length-1==4)
							//{//if starts for case2
				...
				(bm.isequal(case1,ukkaka))||(bm.isequal(case1,ukku)||bm.isequal(case1,in))){
					...
					/*	for(int i=0;i<noun1.length;i++){
							...
							result=bm.addarray(bm.addarray(nounbyte,kal),case1);
										...
										//	}/*else{
												//System.out.println("dubukku");//if ends for case2
											//}*/
								}//else ends
