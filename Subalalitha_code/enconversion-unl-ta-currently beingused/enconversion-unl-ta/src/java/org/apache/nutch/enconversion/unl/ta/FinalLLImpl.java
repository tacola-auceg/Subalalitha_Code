...
//	PrintStream ugt;
	...
	public ConceptToNode addCT_Concept(String cid,String cto,String rl,String did,String sid)
	{
		...
		while(current != null)
		{
			...
			//System.out.println("have i come inside addct:"+temp);
				if(current.getRowNext()==null){
					current.setRowNext(temp);
					//System.out.println("have i come inside addct in if");
				}
				else
				{
					//System.out.println("have i come inside addct inside else modified");
				
					current1=current.getRowNext();
					while(current1.getRowNext()!=null)
					{
					//	////ugt.println("IW");
					//	System.out.println("have i come inside addct inside else and loop");
	...
	public void addRelation(String rl)
	{
		...
		{
			//System.out.println("inside relation:"+rl);
